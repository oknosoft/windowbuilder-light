...
import ContractField from '../../catalogs/contracts/ContractField';
...
export default function ObjHead({obj, setBackdrop}) {
  ...
  return <Grid container spacing={1} ml={1} mr={1}>
    <Grid size={{xs: 12, lg: 4}}>
      ...
      <PartnerField obj={obj} fld="partner" enterTab disabled={userRestricted} list={userRestricted && list.length && list}/>
    </Grid>
    <Grid size={{xs: 12, lg: 4}}>
