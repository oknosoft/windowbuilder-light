...
export class NavDrawer extends Component {
  ...
  render() {
    ...
    const {classes, items, title, handleNavigate, handleIfaceState, NavList: listProps} = props;
    ...
    return (
      <div>
        ...
        >
          ...
          <NavList items={items} handleClose={handleClose} handleNavigate={handleNavigate} handleIfaceState={handleIfaceState} {...listProps}/>
